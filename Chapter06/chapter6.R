...
im(location)
write.csv(location, "F:/Hands-on-Geospatial-Analysis-Using-R-and-QGIS/Chapter06/Data/ppp1.csv")
library(sp)
library(rgdal)
library(maptools)
dhaka_div = readOGR("F:/Hands-on-Geospatial-Analysis-Using-R-and-QGIS/Chapter06/Data","dhaka_div")
plot(dhaka_div)
