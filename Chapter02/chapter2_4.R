...
# SpatialLines
highway = readOGR("F:/Hands-on Geospatial Analysis Using R and QGIS/Chapter 2/Chapter 2_Data","dhaka_highway_polylines")
plot(highway)
...
# load another map
map_bd = readOGR("F:/Hands-on Geospatial Analysis Using R and QGIS/Chapter 2/Chapter 2_Data","BGD_adm3_data_re")
head(map_bd@data)
...
dhaka_div = readOGR("F:/Hands-on Geospatial Analysis Using R and QGIS/Chapter 2/Chapter 2_Data","dhaka_div")
