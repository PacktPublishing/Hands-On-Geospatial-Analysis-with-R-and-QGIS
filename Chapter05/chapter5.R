...
setwd("F:/Hands-on-Geospatial-Analysis-Using-R-and-QGIS/Chapter05/")
# Read metadata
...
band4 = raster("Mosaic/1/LC08_L1TP_137043_20180410_20180417_01_T1_B4.TIF")
band4
plot(band4)
...
# Change CRS of band4 image from UTM to long lat
