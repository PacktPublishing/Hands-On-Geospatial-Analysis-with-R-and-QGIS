...
bd_val = read.csv("F:/Hands-on-Geospatial-Analysis-Using-R-and-QGIS/Chapter 02/Data/r_val.csv", stringsAsFactors = FALSE)
str(bd_val)
...
# SpatialLines
highway = readOGR("F:/Hands-on-Geospatial-Analysis-Using-R-and-QGIS/Chapter 02/Data","dhaka_gazipur")
plot(highway)

map_dhaka = readOGR("F:/Hands-on-Geospatial-Analysis-Using-R-and-QGIS/Chapter 02/Data","dhaka")
plot(map_dhaka)
...
# load another map
map_bd = readOGR("F:/Hands-on-Geospatial-Analysis-Using-R-and-QGIS/Chapter 02/Data","BGD_adm3_data_re")
head(map_bd@data)
...
dhaka_div = readOGR("F:/Hands-on-Geospatial-Analysis-Using-R-and-QGIS/Chapter 02/Data","dhaka_div")
